      ...
      <div className="wrap" style={{ paddingTop:'4.5rem', paddingBottom:'2rem' }}>
        <div className="col-footer">
          ...
          <div>
            ...
            <p style={{ fontSize:12, lineHeight:1.8, color:'#374151', marginBottom:16, maxWidth:240 }}>
              Bridging ambitious Nigerian students with world-class universities in the UK, Canada, and USA since 2010.
            </p>
            <div style={{ fontSize:10, color:'#1e293b', letterSpacing:'.06em', marginBottom:14, fontFamily:'Space Grotesk,sans-serif' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle:'none', padding:0, display:'flex', flexDirection:'column', gap:9 }}>
              {[['/', 'Home'],['/services','Services'],['/about','About Us'],['/universities','Partner Universities'],['/blog','Resources'],['/about#careers','Careers'],['/contact','Contact']].map(([h,l])=>(
                <li key={h}><Link href={h} style={{ fontSize:12, color:'#374151', textDecoration:'none', display:'flex', alignItems:'center', gap:5 }}><ArrowRight size={9} style={{ opacity:.3 }} />{l}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle:'none', padding:0, display:'flex', flexDirection:'column', gap:9 }}>
              {['Education Counselling','University Placement','Visa Application','Course Selection','Accommodation','Pre-Departure Support','Post-Enrolment Help'].map(s=>(
                <li key={s} style={{ display:'flex', alignItems:'center', gap:6, fontSize:12, color:'#374151' }}>
          ...
          <div>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              <div style={{ display:'flex', gap:9, fontSize:12, color:'#374151' }}><MapPin size={13} style={{ color:'#c9a84c', flexShrink:0, marginTop:1 }} /><span>144, Oko Ogba Road, Off Airport Road, Benin City, Nigeria</span></div>
              <div style={{ display:'flex', gap:9, fontSize:12 }}><Phone size={13} style={{ color:'#c9a84c', flexShrink:0 }} /><a href="tel:+2349083353549" style={{ color:'#374151', textDecoration:'none' }}>+234 908 335 3549</a></div>
              <div style={{ display:'flex', gap:9, fontSize:12 }}><Mail size={13} style={{ color:'#c9a84c', flexShrink:0 }} /><a href="mailto:info@wcent.co.uk" style={{ color:'#374151', textDecoration:'none' }}>info@wcent.co.uk</a></div>
              <div style={{ display:'flex', gap:9, fontSize:12, color:'#374151' }}><Clock size={13} style={{ color:'#c9a84c', flexShrink:0 }} /><span>Mon–Fri: 09:00–17:30</span></div>
            </div>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:10 }}>
          <span style={{ fontSize:11, color:'#1e293b' }}>© {new Date().getFullYear()} Withcent Nigeria. All Rights Reserved.</span>
          <div style={{ display:'flex', gap:16, fontSize:11, color:'#1e293b' }}>
